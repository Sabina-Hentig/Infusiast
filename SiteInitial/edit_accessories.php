...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($imgContent) {
        $sql = "UPDATE product_accessories SET product_name='$name', description='$description', quantity='$quantity', is_active='$state', price='$price', picture='$imgContent' WHERE id='$id'";
        $sql_inventory = "UPDATE product_inventory_accessories SET quantity='$quantity', updated_date='NOW()' WHERE product_id='$id'";
    } else {
        $sql = "UPDATE product_accessories SET product_name='$name', description='$description', quantity='$quantity', is_active='$state', price='$price' WHERE id='$id'";
        $sql_inventory = "UPDATE product_inventory_accessories SET quantity='$quantity', updated_date='NOW()' WHERE product_id='$id'";
    }
//  && mysqli_query($cnx, $sql_inventory))
...
// $query = "SELECT * FROM product_accessories WHERE id='$id'";
...
<div class="container">
    ...
    <br>
    <form action="edit_accessories.php" class="form-edit-tea" method="post" enctype="multipart/form-data">
